...
from csd_operations import save_cifs_and_pdbs
...
def main(input_file):
    ...
    if input_parameters["save_homomolecular_cifs"]:
        print("Saving CIF files for the homomolecular clustered families.")
        save_cifs_and_pdbs(input_parameters)
